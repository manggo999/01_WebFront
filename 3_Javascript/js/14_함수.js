...
// 2개의 값을 전달받아 출력하는 함수 => 매개변수 2개 필요
function print1 (num, str) { // 1)함수 선언(매개변수 2개를 가지고있다)
...
// #btn1 클릭 시 #input1의 값을 읽어와 print1() 3)함수 호출
...
document.querySelector("#btn2c").addEventListener("click", function(){
    ...
    const sumFn = function(a, b) {
       return a + b; // 함수를 종료함과 동시에 호출한 곳으로 돌아감
                     // a + b 가지고 호출한 곳으로 돌아감
...
function returnTest(num1, num2) {
    return num1 * num2; // 함수를 종료와 동시에 return 옆에 작성된 값을 가지고
                        // 호출한 쪽으로 돌아감
}
