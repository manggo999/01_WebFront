...
// [해결방법]
// 문자열(string)을 숫자(number)로 변경하는 코드 수행
// 숫자만 작성된 문자열 "123"을
// 진짜 숫자 타입 123 로 바꾸는 방법 : Number("123") --> 123
...
//1 감소 함수
function decrease() {
    // 감소한 count 값을 result2 의 내부 글자로 대입
    result2.innerText = count--;
}
...
console.log(count++); // 50출력 후 51 증가
